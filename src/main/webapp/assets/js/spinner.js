...
return false}
if($.inArray(e.keyCode,[8,46,9,27,13,36,35,37,39])!==-1||(e.which==65&&e.ctrlKey===true)||($this.options.precision>0&&$this.$element.val().indexOf('.')==-1&&e.which==46)){return}
if(e.which<48||e.which>57)return false});this.$element.on('blur',function(e){$this.change($this.$element.val())})}}
Spinner.DEFAULTS={step:1,min:0,max:Infinity,precision:0,strict:true}
